  ...
  return (
    <>
      ...
      <div className="View Intro">
        ...
        <p>A Lasso combines the security of <a className="standard" href="https://github.com/MolochVentures/moloch" target="_blank" rel="noopener noreferrer">Moloch DAO</a> smart contracts and legal compliance of <a className="standard" href="https://www.openlaw.io" target="_blank" rel="noopener noreferrer">OpenLaw</a> legal contracts to create a fully compliant and legal decentralized autonomous organization (DAO) in the state of Wyoming.</p>
